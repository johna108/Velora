...
export default async function DashboardLayout({
  ...
  // Dashboard now relies on cookie selection mostly. 
  // If no cookie set, getDashboardData will fallback to first startup.
        ...
        <div className="flex h-full max-h-screen flex-col gap-2">
          <div className="flex h-14 items-center border-b px-4 lg:h-[60px] lg:px-6">
            ...
            >
              ...
              <span className="font-headline text-xl">Velora</span>
            </Link>
          </div>
          <DashboardNav />
        </div>
